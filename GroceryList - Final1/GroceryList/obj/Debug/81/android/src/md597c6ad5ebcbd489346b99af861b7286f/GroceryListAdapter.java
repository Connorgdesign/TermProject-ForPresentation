...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("GroceryList.GroceryListAdapter, GroceryList", GroceryListAdapter.class, __md_methods);
	}
	...
	public GroceryListAdapter ()
	{
		...
		if (getClass () == GroceryListAdapter.class)
			mono.android.TypeManager.Activate ("GroceryList.GroceryListAdapter, GroceryList", "", this, new java.lang.Object[] {  });
	}
